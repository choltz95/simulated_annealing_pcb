...
def plot_circuit(grid, connections, stats = None):
	...
	for con in connections:
		...
		for connected_component in connections[con]:
			if connected_component not in grid or connections[con][connected_component] == 0.0:
...
'M7':{'dimensions':[41.625000, 149.136000]}, 'M8':{'dimensions':[41.625000, 149.136000]}, 'M9':{'dimensions':[41.625000, 149.136000]}, 'BLOCKAGE':{'dimensions':[200, 100]},
...
for module in d:
	if 'M' in module:
		...
		randx = np.random.randint(0,700)
		randy = np.random.randint(0,250)
		...
		components[module] = geometry.Polygon([[0,0],[0,100],[200,100],[200,0]])
	elif 'EAST' in module:
